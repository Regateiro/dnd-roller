...
class SessionHandler:
    ...
    async def _handle_weekday(self, message: Message, guild_data: GuildData, user: User, fields: list) -> None:
    ...
    async def _handle_schedule(self, message: Message, guild_data: GuildData, user: User, fields: list) -> None:
    ...
    async def _handle_cancel(self, message: Message, guild_data: GuildData, user: User, fields: list) -> None:
        """Cancel a session."""
        date = self._session_service.parse_date(fields[2])
        datestr = self._session_service.format_date(date)
    ...
    async def _handle_available(self, message: Message, guild_data: GuildData, user: User, fields: list) -> None:
    ...
    async def _handle_unavailable(self, message: Message, guild_data: GuildData, user: User, fields: list) -> None:
    ...
    async def _handle_list(self, message: Message, guild_data: GuildData, user: User, fields: list) -> None:
    ...
    async def _handle_next(self, message: Message, guild_data: GuildData, user: User, fields: list) -> None:
